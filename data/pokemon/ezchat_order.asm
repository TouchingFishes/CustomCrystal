...
.ki_gi:    db SUNFLORA, CATERPIE, GYARADOS, RAPIDASH, NINETALES, BELLOSSOM, KINGDRA, KINGLER, -1 ;GIRAFARIG
...
.sa_za:    db RHYHORN, PUPITAR, HITMONLEE, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH, -1 ; CORSOLA, RHYDON should lead this list
.shi_ji:   db SEADRA, VAPOREON, DEWGONG, -1 ;SHELLDER
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, TYRANITAR, -1 ;BLISSEY, CLOYSTER
.hi_bi_pi: db WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1 ;CLEFFA
