...
Moves1:
	...
	move EFFECT_ACCURACY_DOWN,       0, NORMAL,       STATUS,   100, 15,   0      ;FLASH
	...
	move EFFECT_SPEED_DOWN_2,        0, DARK,         STATUS,   100, 10,   0      ;SCARY_FACE
	...
	move EFFECT_CONFUSE_HIT,       120, FIGHTING,     PHYSICAL,  50,  5, 100      ;DYNAMICPUNCH
