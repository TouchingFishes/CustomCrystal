...
Moves1:
	...
	move EFFECT_MULTI_HIT,          20, NORMAL,         90, 10,   0      ;DOUBLESLAP
	...
	move EFFECT_RAZOR_WIND,        100, NORMAL,        100, 10,   0      ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0, NORMAL,        100, 30,   0      ;SWORDS_DANCE
	move EFFECT_NORMAL_HIT,         70, BUG,           100, 30,   0      ;CUT
	...
	move EFFECT_TRAP_TARGET,        35, NORMAL,         85, 20,   0      ;BIND
	move EFFECT_NORMAL_HIT,         80, NORMAL,         80, 20,   0      ;SLAM
	...
	move EFFECT_JUMP_KICK,          85, FIGHTING,       95, 15,   0      ;JUMP_KICK
	...
	move EFFECT_MULTI_HIT,          20, FLYING,         90, 20,   0      ;FURY_ATTACK
	...
	move EFFECT_MULTI_HIT,          20, BUG,            90, 20,   0      ;PIN_MISSILE
	...
	move EFFECT_TRAP_TARGET,        45, FIRE,           85, 15,   0      ;FIRE_SPIN
	...
	move EFFECT_FLY,                70, GROUND,        100, 10,   0      ;DIG
	...
	move EFFECT_JUMP_KICK,         100, FIGHTING,       90, 10,   0      ;HI_JUMP_KICK
	move EFFECT_PARALYZE,            0, DARK,          100, 15,   0      ;GLARE
	...
	move EFFECT_LEECH_HIT,          50, BUG,           100, 15,   0      ;LEECH_LIFE
	move EFFECT_SLEEP,               0, NORMAL,         75, 10,   0      ;LOVELY_KISS
	move EFFECT_NORMAL_HIT,        120, FLYING,         85,  5,   0      ;SKY_ATTACK
	move EFFECT_TRANSFORM,           0, NORMAL,        100, 10,   0      ;TRANSFORM
	move EFFECT_SPEED_DOWN_HIT,     30, WATER,         100, 30,  10      ;BUBBLE
	move EFFECT_CONFUSE_HIT,        70, NORMAL,        100, 10,  20      ;DIZZY_PUNCH
	move EFFECT_SLEEP,               0, GRASS,         100, 15,   0      ;SPORE
	move EFFECT_ACCURACY_DOWN,       0, NORMAL,        100, 15,   0      ;FLASH
	move EFFECT_PSYWAVE,             1, PSYCHIC_TYPE,  100, 15,   0      ;PSYWAVE
	move EFFECT_SPLASH,              0, NORMAL,        100, 40,   0      ;SPLASH
	move EFFECT_DEFENSE_UP_2,        0, POISON,        100, 40,   0      ;ACID_ARMOR
	move EFFECT_NORMAL_HIT,        120, WATER,          85, 10,   0      ;CRABHAMMER
	move EFFECT_SELFDESTRUCT,      250, NORMAL,        100,  5,   0      ;EXPLOSION
	move EFFECT_MULTI_HIT,          20, NORMAL,         90, 15,   0      ;FURY_SWIPES
	...
	move EFFECT_TRIPLE_KICK,        25, FIGHTING,       90, 10,   0      ;TRIPLE_KICK
	...
	move EFFECT_SNORE,              70, NORMAL,        100, 15,  30      ;SNORE
	...
	move EFFECT_NORMAL_HIT,        100, FLYING,        100,  5,   0      ;AEROBLAST
	...
	move EFFECT_DEFENSE_UP_HIT,     70, STEEL,         100, 25,  10      ;STEEL_WING
	move EFFECT_MEAN_LOOK,           0, GHOST,         100,  5,   0      ;MEAN_LOOK
	...
	move EFFECT_PARALYZE_HIT,       75, DRAGON,        100, 20,  20      ;DRAGONBREATH
	...
	move EFFECT_ATTACK_UP_HIT,      50, STEEL,         100, 35,  10      ;METAL_CLAW
	...
	move EFFECT_TWISTER,            95, FLYING,        100, 20,  10      ;TWISTER
	...
	move EFFECT_DEFENSE_DOWN_HIT,   60, FIGHTING,      100, 15,  20      ;ROCK_SMASH
	move EFFECT_TRAP_TARGET,        45, WATER,          85, 15,   0      ;WHIRLPOOL
...
Moves2:
	...
	move EFFECT_NORMAL_HIT,         40, FAIRY,         100, 15,   0      ;FAIRY_WIND
	move EFFECT_HEX,                65, GHOST,         100, 10,   0      ;HEX use Memento animation
	move EFFECT_ALWAYS_HIT,         60, ELECTRIC,      100, 20,   0      ;SHOCK_WAVE
	move EFFECT_RECOIL_HIT,        120, ELECTRIC,      100, 15,   0      ;VOLT_TACKLE
	move EFFECT_LEECH_HIT,          40, FAIRY,         100, 15,   0      ;DEVILS_KISS use Draining Kiss animation
	move EFFECT_ATTACK_DOWN_HIT,    90, FAIRY,          90, 10,  10      ;PLAY_ROUGH
    move EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY,         100, 15,  20      ;MOON_BLAST
	...
	move EFFECT_ATTACK_UP_HIT,     100, STEEL,          85, 10,   0      ;METEOR_MASH
	move EFFECT_ALL_UP_HIT,         60, BUG,           100, 10,   0      ;SILVER_WIND
	move EFFECT_LEECH_HIT,          60, FIGHTING,      100, 10,   0      ;DRAIN_PUNCH
	move EFFECT_ALWAYS_HIT,         60, GRASS,         100, 20,   0      ;MAGICAL_LEAF
	move EFFECT_PURSUIT,            90, GRASS,         100, 20,   0      ;LEAF_BLADE
	move EFFECT_SP_DEF_DOWN_HIT,    80, GRASS,         100, 15,  10      ;ENERGY_BALL
	move EFFECT_SLEEP,               0, GRASS,          55, 15,   0      ;GRASSWHISTLE
	move EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,         100, 15,  10      ;FLASH_CANNON
	move EFFECT_MOONLIGHT,           0, FAIRY,         100,  5,   0      ;DARK_PULSE
	move EFFECT_RAIN_DANCE,          0, ICE,            90,  5,   0      ;HAIL
