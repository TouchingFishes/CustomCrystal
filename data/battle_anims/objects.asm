...
; BATTLE_ANIM_OBJ_RECOVER
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_RECOVER, BATTLE_ANIM_FUNC_RECOVER, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_BUBBLE
...
; BATTLE_ANIM_OBJ_PRESENT
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLE_ANIM_FRAMESET_ITEM_BAG, BATTLE_ANIM_FUNC_PRESENT_SMOKESCREEN, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_STATUS
